...
[Link to filtered differential expression tables with apeglm shrinkage](https://nih.sharepoint.com/:f:/r/sites/NIDDK-GuydoshLab/Shared%20Documents/TK_61/Results/DE_with_filter_and_shrinkage_apeglm?csf=1&web=1&e=AQEZ12)

[Link to filtered differential expression tables with no shrinkage](https://nih.sharepoint.com/:f:/r/sites/NIDDK-GuydoshLab/Shared%20Documents/TK_61/Results/DE_with_filter_no_shrinkage?csf=1&web=1&e=gUQXfr)

[Link to filtered differential expression tables with ashr shrinkage](https://nih.sharepoint.com/:f:/r/sites/NIDDK-GuydoshLab/Shared%20Documents/TK_61/Results/DE_with_filter_and_shrincage_ashr?csf=1&web=1&e=y9LuYJ)

[Link to unfiltered differential expression tables with ashr shrinkage](https://nih.sharepoint.com/:f:/r/sites/NIDDK-GuydoshLab/Shared%20Documents/TK_61/Results/DE_unfiltered_shrinkage_ashr?csf=1&web=1&e=MJdudr)

[Link to unfiltered differential expression tables with no shrinkage](https://nih.sharepoint.com/:f:/r/sites/NIDDK-GuydoshLab/Shared%20Documents/TK_61/Results/DE_unfiltered_no_shrinkage?csf=1&web=1&e=kJBEwI)
...
[Link to mean normalized read counts (DESeq2 norm)](https://nih.sharepoint.com/:f:/r/sites/NIDDK-GuydoshLab/Shared%20Documents/TK_61/Results/Mean_norm_counts?csf=1&web=1&e=FpVpx7)
...
# Shrinkage type (either NONE, apeglm, ashr)
...
res_wtIC_vs_wtNone.shr <- lfcShrink(dds.one.cds.wt, coef = "Group_gt_ind_WTpolyIC_vs_WTNone", type = "ashr", )
res_wt25A_vs_wtNone.shr <- lfcShrink(dds.one.cds.wt, coef = "Group_gt_ind_WT25A_vs_WTNone", type = "ashr")

res_wtIC_vs_wtNone.apeglm <- lfcShrink(dds.one.cds.wt, coef = "Group_gt_ind_WTpolyIC_vs_WTNone", type = "apeglm", )
res_wt25A_vs_wtNone.apeglm <- lfcShrink(dds.one.cds.wt, coef = "Group_gt_ind_WT25A_vs_WTNone", type = "apeglm")
...
# Generate MA plots
make_MA_plots(res_wtIC_vs_wtNone, file_prefix = "res_wtIC_vs_wtNone_RNAseq_cds")
make_MA_plots(res_wt25A_vs_wtNone, file_prefix = "res_wt25A_vs_wtNone_RNAseq_cds")
make_MA_plots(res_wtIC_vs_wtNone.shr, file_prefix = "res_wtIC_vs_wtNone_RNAseq_cds_shr")
make_MA_plots(res_wt25A_vs_wtNone.shr, file_prefix = "res_wt25A_vs_wtNone_RNAseq_cds_shr")
make_MA_plots(res_wtIC_vs_wtNone.apeglm, file_prefix = "res_wtIC_vs_wtNone_RNAseq_cds_apeglm")
make_MA_plots(res_wt25A_vs_wtNone.apeglm, file_prefix = "res_wt25A_vs_wtNone_RNAseq_cds_apeglm")

if (shrinkage_type == 'NONE'){
  print("No shrinkage correction applied to Log2FC")
} else if (shrinkage_type == 'ashr'){
  res_wtIC_vs_wtNone <- res_wtIC_vs_wtNone.shr
  res_wt25A_vs_wtNone <- res_wt25A_vs_wtNone.shr
} else if (shrinkage_type == 'apeglm'){
  res_wtIC_vs_wtNone <- res_wtIC_vs_wtNone.apeglm
  res_wt25A_vs_wtNone <- res_wt25A_vs_wtNone.apeglm
} else {
  print("Shrinkage_type should be one of c(NONE, ashr, apeglm)")
  quit(10)
}
...
res_koIC_vs_koNone.shr <- lfcShrink(dds.one.cds.ko, coef = "Group_gt_ind_RNaseL_KOpolyIC_vs_RNaseL_KONone", type = "ashr")
res_ko25A_vs_koNone.shr <- lfcShrink(dds.one.cds.ko, coef = "Group_gt_ind_RNaseL_KO25A_vs_RNaseL_KONone", type = "ashr")

res_koIC_vs_koNone.apeglm <- lfcShrink(dds.one.cds.ko, coef = "Group_gt_ind_RNaseL_KOpolyIC_vs_RNaseL_KONone", type = "apeglm")
res_ko25A_vs_koNone.apeglm <- lfcShrink(dds.one.cds.ko, coef = "Group_gt_ind_RNaseL_KO25A_vs_RNaseL_KONone", type = "apeglm")


# Generate MA plots
make_MA_plots(res_koIC_vs_koNone, file_prefix = "res_koIC_vs_koNone_RNAseq_cds")
make_MA_plots(res_ko25A_vs_koNone, file_prefix = "res_ko25A_vs_koNone_RNAseq_cds")
make_MA_plots(res_koIC_vs_koNone.shr, file_prefix = "res_koIC_vs_koNone_RNAseq_cds_shr")
make_MA_plots(res_ko25A_vs_koNone.shr, file_prefix = "res_ko25A_vs_koNone_RNAseq_cds_shr")
make_MA_plots(res_koIC_vs_koNone.apeglm, file_prefix = "res_koIC_vs_koNone_RNAseq_cds_apeglm")
make_MA_plots(res_ko25A_vs_koNone.apeglm, file_prefix = "res_ko25A_vs_koNone_RNAseq_cds_apeglm")

if (shrinkage_type == 'NONE'){
  print("No shrinkage correction applied to Log2FC")
} else if (shrinkage_type == 'ashr'){
  res_koIC_vs_koNone <- res_koIC_vs_koNone.shr
  res_ko25A_vs_koNone <- res_ko25A_vs_koNone.shr
} else if (shrinkage_type == 'apeglm'){
  res_koIC_vs_koNone <- res_koIC_vs_koNone.apeglm
  res_ko25A_vs_koNone <- res_ko25A_vs_koNone.apeglm
} else {
  print("Shrinkage_type should be one of c(NONE, ashr, apeglm)")
  quit(10)
}
...
```
### Calculate mean normalized read counts per gene - CDS
```{r}
...
# Keep genes with at least 10 reads total across samples
keep <- rowSums(counts(dds.one.exon)) >= N_reads
dds.one.exon <- dds.one.exon[keep,]
```
...
# Using lfcShrink instead of results to reduce high Log2FC bias of genes with low expression
res_wtIC_vs_wtNone.shr <- lfcShrink(dds.one.exon.wt, coef = "Group_gt_ind_WTpolyIC_vs_WTNone", type = "ashr", )
res_wt25A_vs_wtNone.shr <- lfcShrink(dds.one.exon.wt, coef = "Group_gt_ind_WT25A_vs_WTNone", type = "ashr")

res_wtIC_vs_wtNone.apeglm <- lfcShrink(dds.one.exon.wt, coef = "Group_gt_ind_WTpolyIC_vs_WTNone", type = "apeglm", )
res_wt25A_vs_wtNone.apeglm <- lfcShrink(dds.one.exon.wt, coef = "Group_gt_ind_WT25A_vs_WTNone", type = "apeglm")


# Generate MA plots
make_MA_plots(res_wtIC_vs_wtNone, file_prefix = "res_wtIC_vs_wtNone_RNAseq_exon")
make_MA_plots(res_wt25A_vs_wtNone, file_prefix = "res_wt25A_vs_wtNone_RNAseq_exon")
make_MA_plots(res_wtIC_vs_wtNone.shr, file_prefix = "res_wtIC_vs_wtNone_RNAseq_exon_shr")
make_MA_plots(res_wt25A_vs_wtNone.shr, file_prefix = "res_wt25A_vs_wtNone_RNAseq_exon_shr")
make_MA_plots(res_wtIC_vs_wtNone.apeglm, file_prefix = "res_wtIC_vs_wtNone_RNAseq_exon_apeglm")
make_MA_plots(res_wt25A_vs_wtNone.apeglm, file_prefix = "res_wt25A_vs_wtNone_RNAseq_exon_apeglm")
...
res_koIC_vs_koNone.shr <- lfcShrink(dds.one.exon.ko, coef = "Group_gt_ind_RNaseL_KOpolyIC_vs_RNaseL_KONone", type = "ashr")
res_ko25A_vs_koNone.shr <- lfcShrink(dds.one.exon.ko, coef = "Group_gt_ind_RNaseL_KO25A_vs_RNaseL_KONone", type = "ashr")

res_koIC_vs_koNone.apeglm <- lfcShrink(dds.one.exon.ko, coef = "Group_gt_ind_RNaseL_KOpolyIC_vs_RNaseL_KONone", type = "apeglm")
res_ko25A_vs_koNone.apeglm <- lfcShrink(dds.one.exon.ko, coef = "Group_gt_ind_RNaseL_KO25A_vs_RNaseL_KONone", type = "apeglm")

# Generate MA plots
make_MA_plots(res_koIC_vs_koNone, file_prefix = "res_koIC_vs_koNone_RNAseq_exon")
make_MA_plots(res_ko25A_vs_koNone, file_prefix = "res_ko25A_vs_koNone_RNAseq_exon")
make_MA_plots(res_koIC_vs_koNone.shr, file_prefix = "res_koIC_vs_koNone_RNAseq_exon_shr")
make_MA_plots(res_ko25A_vs_koNone.shr, file_prefix = "res_ko25A_vs_koNone_RNAseq_exon_shr")
make_MA_plots(res_koIC_vs_koNone.apeglm, file_prefix = "res_koIC_vs_koNone_RNAseq_exon_apeglm")
make_MA_plots(res_ko25A_vs_koNone.apeglm, file_prefix = "res_ko25A_vs_koNone_RNAseq_exon_apeglm")
...
```
### Calculate mean normalized read counts per gene - exons
```{r}
dir.create('./Mean_norm_counts', showWarnings = FALSE)
mean_norm_counts.wt <- apply(counts(dds.one.exon.wt, normalized=TRUE), 1, function(x) mean(x))
mean_norm_counts.ko <- apply(counts(dds.one.exon.ko, normalized=TRUE), 1, function(x) mean(x))

write.table(x = as.data.frame(mean_norm_counts.wt), file = './Mean_norm_counts/mean_norm_counts.wt.exon.txt', sep = "\t" )
write.table(x = as.data.frame(mean_norm_counts.ko), file = './Mean_norm_counts/mean_norm_counts.ko.exon.txt', sep = "\t" )
```
...
# Using lfcShrink instead of results to reduce high Log2FC bias of genes with low expression
res_wtIC_vs_wtNone.shr <- lfcShrink(dds.one.RS.wt, coef = "Group_gt_ind_WTpolyIC_vs_WTNone", type = "ashr")
res_wt25A_vs_wtNone.shr <- lfcShrink(dds.one.RS.wt, coef = "Group_gt_ind_WT25A_vs_WTNone", type = "ashr")

# apeglm
# Using lfcShrink instead of results to reduce high Log2FC bias of genes with low expression
res_wtIC_vs_wtNone.apeglm <- lfcShrink(dds.one.RS.wt, coef = "Group_gt_ind_WTpolyIC_vs_WTNone", type = "apeglm")
res_wt25A_vs_wtNone.apeglm <- lfcShrink(dds.one.RS.wt, coef = "Group_gt_ind_WT25A_vs_WTNone", type = "apeglm")
...
make_MA_plots(res_wtIC_vs_wtNone.shr, file_prefix = "res_wtIC_vs_wtNone_RIBOseq_cds_shr")
make_MA_plots(res_wt25A_vs_wtNone.shr, file_prefix = "res_wt25A_vs_wtNone_RIBOseq_cds_shr")
make_MA_plots(res_wtIC_vs_wtNone.apeglm, file_prefix = "res_wtIC_vs_wtNone_RIBOseq_cds_apeglm")
make_MA_plots(res_wt25A_vs_wtNone.apeglm, file_prefix = "res_wt25A_vs_wtNone_RIBOseq_cds_apeglm")
...
res_koIC_vs_koNone.shr <- lfcShrink(dds.one.RS.ko, coef = "Group_gt_ind_RNaseL_KOpolyIC_vs_RNaseL_KONone", type = "ashr")
res_ko25A_vs_koNone.shr <- lfcShrink(dds.one.RS.ko, coef = "Group_gt_ind_RNaseL_KO25A_vs_RNaseL_KONone", type = "ashr")

# apeglm
# Using lfcShrink instead of results to reduce high Log2FC bias of genes with low expression
res_koIC_vs_koNone.apeglm<- lfcShrink(dds.one.RS.ko, coef = "Group_gt_ind_RNaseL_KOpolyIC_vs_RNaseL_KONone", type = "apeglm")
res_ko25A_vs_koNone.apeglm <- lfcShrink(dds.one.RS.ko, coef = "Group_gt_ind_RNaseL_KO25A_vs_RNaseL_KONone", type = "apeglm")
...
make_MA_plots(res_koIC_vs_koNone.shr, file_prefix = "res_koIC_vs_koNone_RIBOseq_cds_shr")
make_MA_plots(res_ko25A_vs_koNone.shr, file_prefix = "res_ko25A_vs_koNone_RIBOseq_cds_shr")
make_MA_plots(res_koIC_vs_koNone.apeglm, file_prefix = "res_koIC_vs_koNone_RIBOseq_cds_apeglm")
make_MA_plots(res_ko25A_vs_koNone.apeglm, file_prefix = "res_ko25A_vs_koNone_RIBOseq_cds_apeglm")
...
```{r}
dir.create('./Mean_norm_counts', showWarnings = FALSE)
mean_norm_counts.wt <- apply(counts(dds.one.RS.wt, normalized=TRUE), 1, function(x) mean(x))
mean_norm_counts.ko <- apply(counts(dds.one.RS.ko, normalized=TRUE), 1, function(x) mean(x))

write.table(x = as.data.frame(mean_norm_counts.wt), file = './Mean_norm_counts/mean_norm_counts.wt.RS.txt', sep = "\t" )
write.table(x = as.data.frame(mean_norm_counts.ko), file = './Mean_norm_counts/mean_norm_counts.ko.RS.txt', sep = "\t" )
```
